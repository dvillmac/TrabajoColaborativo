...
public class Bloque {
	...
	//C�lculo de nuevo hash basado en el contenido de los bloques
	...
	public void minarBloque(int dificultad) {
		String destino = Hash.obtenerCadenaDificultad(dificultad); //Creaci�n de una cadena con dificultad * "0" 
