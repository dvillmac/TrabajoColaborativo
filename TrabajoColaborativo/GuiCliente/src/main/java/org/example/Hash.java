...
public class Hash {
	...
	public static String aplicarSha256(String entrada){
		...
		try {
			...
			StringBuffer cadenaHex = new StringBuffer(); // Contendr� el hash en hexadecimal
	...
	//Aplicaci�on de la firma ECDSA y devoluci�n del resultado en bytes.
